					...
					if (!empty($includeusers))
					{
					    ...
					    foreach ($includeusers as $includeuser) { ?>
					        ...
					        <div class="faculty-module widget alpha omega theme_hook">
								...
								<div class="faculty-name five columns">
								...
								<div class="faculty-contact five columns columns omega">
									<div class="faculty-specialty">
										<h5><?php _e( 'Specialties', 'mythology' ); ?>:</h5>
										
										<span><?php echo esc_html( $includeuser->faculty_specialty_meta ); ?></span>
									</div>
								</div>
